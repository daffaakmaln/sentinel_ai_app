...
class _ElderlyEditPageState extends State<ElderlyEditPage> {
  ...
  final _healthConditionController =
      TextEditingController(); // Ganti dari medical_condition
  ...
  void _populateForm() {
    ...
    _healthConditionController.text =
        _elderly?['health_condition'] ?? _elderly?['medical_condition'] ?? '';
  ...
  Future<void> _updateElderly() async {
    ...
    if (age == null || age <= 0) {
      _showErrorDialog('Usia harus berupa angka yang valid');
      return;
    }
      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Form(
                key: _formKey,
                child: Column(
                  children: [_buildFormCard(), const SizedBox(height: 80)],
                ),
              ),
            ),
    );
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            initialValue:
                validValue, // Gunakan validValue yang sudah dipastikan
